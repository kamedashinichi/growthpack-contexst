...
const PDF_PATH = '/downloads/whitepaper-department-2026.pdf';
const DOC_ID = 'department-2026';
...
export function WPDownloadButton() {
  ...
  return (
    <a
      ...
      download
      onClick={() => {
        track('wp_download', { location: 'v2_department_lp', document: DOC_ID });
        trackGA4('wp_download', { location: 'v2_department_lp', document: DOC_ID });
      }}

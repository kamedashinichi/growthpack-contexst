...
const PDF_PATH = '/downloads/whitepaper-drugstore-2026.pdf';
const DOC_ID = 'drugstore-2026';
...
export function WPDownloadButton() {
  ...
  return (
    <a
      ...
      download
      onClick={() => {
        track('wp_download', { location: 'v2_drugstore_lp', document: DOC_ID });
        trackGA4('wp_download', { location: 'v2_drugstore_lp', document: DOC_ID });
      }}

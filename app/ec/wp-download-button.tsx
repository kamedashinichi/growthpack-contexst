...
const PDF_PATH = '/downloads/whitepaper-ec-2026.pdf';
const DOC_ID = 'ec-2026';
...
export function WPDownloadButton() {
  ...
  return (
    <a
      ...
      download
      onClick={() => {
        track('wp_download', { location: 'v2_ec_lp', document: DOC_ID });
        trackGA4('wp_download', { location: 'v2_ec_lp', document: DOC_ID });
      }}

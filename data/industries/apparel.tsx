...
export const apparelData: IndustryLPData = {
  ...
  featureSection: {
    ...
    items: [
      { image: "/images/会員証.png", name: "LINE会員証", description: "全ブランド共通の会員証で5秒登録" },
      { image: "/images/1to1.png", name: "1to1コミュニケーション", description: "担当交代しても対話履歴を引き継ぎ" },
      { image: "/images/クーポン.png", name: "クーポン配信", description: "購買データに基づくセグメント配信" },
      { image: "/images/ギフト.png", name: "ギフト", description: "友人紹介でブランドファンを拡大" },
